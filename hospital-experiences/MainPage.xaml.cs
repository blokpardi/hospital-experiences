...
namespace mtHospitalExperiences
{
    public partial class MainPage : PhoneApplicationPage
    {
        // This is only an example. You must insert your own URL.
        private string _homeURL = "/assets/index.html"; //"http://m.microsoftstore.com/msusa/";
        ...
        public MainPage()
        {
            ...
            Browser.ScriptNotify += HTML_Script;
        ...
        void MainPage_BackKeyPress(object sender, System.ComponentModel.CancelEventArgs e)
        {
            if (_backstack)
            {
                ...
                //try
                //{
                Browser.InvokeScript("pageNav", new string[] { "null" });
                //}
                //catch { }
            }
        }
        ...
        private void ShareApplicationBar_Click(object sender, EventArgs e)  
        {
            ...
            shareLinkTask.Title = "Hospital Experiences";
            shareLinkTask.LinkUri = Windows.ApplicationModel.Store.CurrentApp.LinkUri;
            shareLinkTask.Message = "Here's an app you might like!";
        ...
        {
            Browser.IsScriptEnabled = true;
            Browser.Height = Application.Current.Host.Content.ActualHeight;
        }

        private void AboutMenuItem_Click(object sender, EventArgs e)
        {
            Browser.InvokeScript("showAbout");
        }
