...
(function () {
    ...
    var grouped = stateList.createGrouped(function (item) {
        return item.stateName.toUpperCase().charAt(0);
    }, function (item) {
        return {
            title: item.stateName.toUpperCase().charAt(0)
        };
    }, function (left, right) {
        return left.charCodeAt(0) - right.charCodeAt(0);
    });
   
    WinJS.Namespace.define("mt.ListView", {
        data: grouped
    });
